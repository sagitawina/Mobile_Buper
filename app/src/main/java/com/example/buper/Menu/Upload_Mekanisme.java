...
public class Upload_Mekanisme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__mekanisme);
        progressDialog =new ProgressDialog(Upload_Mekanisme.this);
        ...
        Simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (EasyPermissions.hasPermissions(Upload_Mekanisme.this, galleryPermissions)) {
                    uploadFile();
                } else {
                    EasyPermissions.requestPermissions(Upload_Mekanisme.this, "Access for storage",
...
//                            progressDialog.dismiss();
                            ...
                            String pesan_login=jsonRESULTS.getString("message");
                            Toast.makeText(Upload_Mekanisme.this, ""+pesan_login, Toast.LENGTH_SHORT).show();
...
//                ResponseBody responseBody=response.body();
                try {
                    Toast.makeText(Upload_Mekanisme.this, "", Toast.LENGTH_SHORT).show();
