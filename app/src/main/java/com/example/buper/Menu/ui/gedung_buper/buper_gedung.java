...
public class buper_gedung extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager llm=new GridLayoutManager(buper_gedung.this,2);
    ...
    private void tampilmenu() {
        ...
        Call<Response_Gedun> menuCall = api.tampil_buper(jenis);
            ...
            public void onResponse(Call<Response_Gedun> call, Response<Response_Gedun> response) {
                if (response.isSuccessful()){
                    ...
                    if (status){
                        ...
                        Toast.makeText(buper_gedung.this, "Tidak Ada data Menu saat ini", Toast.LENGTH_SHORT).show();
                    }
                }
            }
